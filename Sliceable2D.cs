...
/// <summary>
/// This is the script provided by our asset pack. There have been edits to 
/// </summary>
namespace Slicer2D {
	...
	public class Sliceable2D : MonoBehaviour {
		...
		public List<GameObject> PerformResult(List<Polygon2D> result, Slice2D slice) {
			...
			GameObject Cutmanager = GameObject.Find("CutManager");
			cutCount cutmanage = Cutmanager.GetComponent<cutCount>();
			GameObject Clickmanager = GameObject.Find("ClickManager");
			ClickManager clickmanage = Clickmanager.GetComponent<ClickManager>();
			cutmanage.cutCounts++;
			clickmanage.click1 = false;
			clickmanage.click2 = false;
			...
			foreach (Polygon2D id in result) {
				...
				if (SceneManager.GetActiveScene().name == "KamaryStep2CutOnion" || SceneManager.GetActiveScene().name == "RamenStep1" || SceneManager.GetActiveScene().name == "BoredCut" || SceneManager.GetActiveScene().name == "StirFryStep2")
				{
					if (gObject.name == "Onion (2)" && cutmanage.cutCounts == 1)
					{
						gObject.SetActive(false);
					}
					if (gObject.name == "Onion (1) (1)" && cutmanage.cutCounts == 2)
					{
						gObject.SetActive(false);
					}
					//if (gObject.name == "Onion (1) (2) (2)" && cutmanage.cutCounts == 3)
					//{
					//	gObject.SetActive(false);
					//}
					//if (gObject.name == "Onion (1) (2) (1) (1)" && cutmanage.cutCounts == 4)
					//{
					//	gObject.SetActive(false);
					//}
					//if (gObject.name == "Onion (1) (2) (1) (2) (1)" && cutmanage.cutCounts == 5)
					//{
					//	gObject.SetActive(false);
					//}
					//if (gObject.name == "Onion (1) (2) (1) (2) (2) (1)" && cutmanage.cutCounts == 6)
					//{
					//	gObject.SetActive(false);
					//}
					//if (gObject.name == "Onion (1) (2) (1) (2) (2) (2) (1)" && cutmanage.cutCounts == 7)
					//{
					//	gObject.SetActive(false);
					//}
				}
				if (SceneManager.GetActiveScene().name == "KamaryStep3CutPepper" || SceneManager.GetActiveScene().name == "BoredCut2")
				{
					if (gObject.name == "Pepper (2)" && cutmanage.cutCounts == 1)
					{
						gObject.SetActive(false);
						 
					}
					if (gObject.name == "Pepper (1) (2)" && cutmanage.cutCounts == 2)
					{
						gObject.SetActive(false);
					}
					//if (gObject.name == "Pepper (1) (1) (2)" && cutmanage.cutCounts == 3)
					//{
					//	gObject.SetActive(false);
					//}
					//if (gObject.name == "Pepper (1) (1) (1) (2)" && cutmanage.cutCounts == 4)
					//{
					//	gObject.SetActive(false);
					//}
					//if (gObject.name == "Pepper (1) (1) (1) (1) (2)" && cutmanage.cutCounts == 5)
					//{
					//	gObject.SetActive(false);
					//}
					//if (gObject.name == "Pepper (1) (1) (1) (1) (1) (1)" && cutmanage.cutCounts == 6)
					//{
					//	gObject.SetActive(false);
					//}
					//if (gObject.name == "Pepper (1) (1) (1) (1) (1) (2) (1)" && cutmanage.cutCounts == 7)
					//{
					//	gObject.SetActive(false);
					//}
				}
				//if (SceneManager.GetActiveScene().name == "ExomorphStep4Cut")
				//{
				//	if (gObject.name == "ExoMorph (2)" && cutmanage.cutCounts == 1)
				//	{
				//		gObject.SetActive(false);
				//	}
				//	if (gObject.name == "ExoMorph (1) (2)" && cutmanage.cutCounts == 2)
				//	{
				//		gObject.SetActive(false);
				//	}
				//	if (gObject.name == "ExoMorph (1) (1) (1)" && cutmanage.cutCounts == 3)
				//	{
				//		gObject.SetActive(false);
				//	}
				//	if (gObject.name == "ExoMorph (1) (1) (2) (2)" && cutmanage.cutCounts == 4)
				//	{
				//		gObject.SetActive(false);
				//	}
				//	if (gObject.name == "ExoMorph (1) (1) (2) (1) (2)" && cutmanage.cutCounts == 5)
				//	{
				//		gObject.SetActive(false);
				//	}
				//	if (gObject.name == "ExoMorph (1) (1) (2) (1) (1) (2)" && cutmanage.cutCounts == 6)
				//	{
				//		gObject.SetActive(false);
				//	}
				//	if (gObject.name == "ExoMorph (1) (1) (2) (1) (1) (1) (2)" && cutmanage.cutCounts == 7)
				//	{
				//		gObject.SetActive(false);
				//	}
				//}
		...
		public Slice2D LinearSlice(Pair2D slice, bool perform = true) {
			...
			if (colliderPolygon != null) {
				...
				if (perform) {
					...
					GameObject Clickmanager = GameObject.Find("ClickManager");
					ClickManager clickmanage = Clickmanager.GetComponent<ClickManager>();
					if (clickmanage.click1 && clickmanage.click2)
                    {
